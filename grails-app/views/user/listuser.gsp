...
<%@ page import="userservice.Calendar" %>
<!DOCTYPE html>
<html>
	<head>
		<meta name="layout" content="main">
		<g:set var="entityName" value="${message(code: 'user.label', default: 'Calendar')}" />
		<title><g:message code="default.listuser.label" args="[entityName]" /></title>
	</head>
	<body>
		<a href="#listuser-user" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="listuser-user" class="content scaffold-listuser" role="main">
